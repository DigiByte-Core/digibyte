...
- **Live mainnet validation** (full record: `doc/v9.26.4/V9.26.4_MAINNET_VALIDATION.md`):
...
| Document | Content |
|---|---|
| `doc/v9.26.4/V9.26.4_PRUNING_PLAN.md` | Design + full TDD test plan |
| `doc/v9.26.4/V9.26.4_PRUNING_EXPLAINER.md` | Short shareable community explainer |
| `doc/v9.26.4/V9.26.4_MAINNET_VALIDATION.md` | The live mainnet test record |
