...
DigiByte Core version 8.22.1 is now available from:

  <https://github.com/DigiByte-Core/digibyte/releases/tag/untagged-73c9690d8b8d5a70cb8d/>
...
frequently tested on them.  It is not recommended to use DigiByte Core on unsupported systems.
...
[Transifex](https://www.transifex.com/digibyte-core/digibyte/).
