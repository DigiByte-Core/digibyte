8.22.0 Release Notes
==================

DigiByte Core version 8.22.0 is now available from:

  <https://github.com/DigiByte-Core/digibyte/releases/tag/untagged-c8e00596cd15cf452c07/>
...
From DigiByte Core 8.22.0 onwards, macOS versions earlier than 10.14 are no longer supported.
...
- A new CLI `-addrinfo` command returns the number of addresses known to the
  ...
  like `-onlynet=<network>` or to upgrade to this release of DigiByte Core 8.22.0
...
- bitcoin/bitcoin#22589 net, doc: update I2P hardcoded seeds and docs for 8.22.0 (jonatack)
...
- bitcoin/bitcoin#21036 gitian: Bump descriptors to focal for 8.22.0 (fanquake)
...
[Transifex](https://www.transifex.com/digibyte-core/digibute/).
