...
**Overview:**
Activated February 2014, _DigiShield_ is a hard fork implemented to protect the DigiByte blockchain from a multi-pool vulnerability. This vulnerability allowed mining pools to mine large amounts of DigiByte at low difficulty levels.
...
**Overview:**
**_Segregated Witness (SegWit)_** was activated on the DigiByte blockchain in April 2017. DigiByte was one of the first major blockchain to implement SegWit, preceding Litecoin by several weeks and Bitcoin by several months.
