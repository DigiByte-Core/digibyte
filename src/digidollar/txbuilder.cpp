...
TxBuilderResult TransferTxBuilder::BuildTransferTransaction(const TxBuilderTransferParams& params) {
    ...
    LogPrint(BCLog::DIGIDOLLAR, "DigiDollar: TxBuilder - adding fee inputs\n");
    ...
    LogPrint(BCLog::DIGIDOLLAR, "DigiDollar: TxBuilder - adding recipient outputs\n");
    for (const auto& [address, amount] : params.recipients) {
    ...
    if (ddChange > 0) {
        ...
        LogPrint(BCLog::DIGIDOLLAR, "DigiDollar: Added DD change output\n");
    } else if (ddChange < 0) {
    ...
    LogPrint(BCLog::DIGIDOLLAR, "DigiDollar: Fee calculation completed\n");
    ...
    if (totalFeeIn > 0) {
        ...
        if (dgbChange > 0 && dgbChange >= DUST_THRESHOLD) {
            ...
            LogPrint(BCLog::DIGIDOLLAR, "DigiDollar: Added DGB change output\n");
        }
    }
    ...
    tx.vout.push_back(CTxOut(0, metadataScript));
    LogPrint(BCLog::DIGIDOLLAR, "DigiDollar: Added DD transfer metadata\n");
    ...
    LogPrint(BCLog::DIGIDOLLAR, "DigiDollar: Conservation check completed\n");
    ...
    LogPrint(BCLog::DIGIDOLLAR, "DigiDollar: Transaction finalized\n");
